...
def main():
    ...
    dados_tratados_daily = transformation.transform(dados_brutos_daily, nome_tabela="forecast_7days_daily")
    ...
    dados_tratados_hourly = transformation.transform(dados_brutos_hourly, nome_tabela="forecast_7days_hourly")
